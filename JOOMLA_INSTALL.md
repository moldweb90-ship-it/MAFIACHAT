...
## Способ: Вставка скрипта в шаблон
...
5. Найдите раздел **"Дополнительные скрипты"** или **"Custom Code"** в `<head>` или перед закрывающим `</body>`
...
- На сайте появится голубая кнопка в правом нижнем углу
- При клике на кнопку откроется чат
- Чат открывается сразу без intro screen (благодаря параметру `?widget=true`)
